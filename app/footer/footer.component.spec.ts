...
describe('Footer component', () => {
  ...
  it('should set showAbout to the value of environment.info.enableAboutStatement', () => {
    comp.ngOnInit();
    expect(comp.showAbout).toBe(environment.info.enableAboutStatement);
  });


  it('should set showCredits to the value of environment.info.enableCreditsStatement', () => {
    comp.ngOnInit();
    expect(comp.showCredits).toBe(environment.info.enableCreditsStatement);
  });

  it('should set showHelp to the value of environment.info.enableHelpStatement', () => {
    comp.ngOnInit();
    expect(comp.showHelp).toBe(environment.info.enableHelpStatement);
  });
